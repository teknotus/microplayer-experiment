...
window.onload = function(e){
    ...
    bar.pDiv.className='player player-bottomcenterleft';
    ...
    addPlayers = function(){
	foo.loadPlayerYouTube('U4Gg1Bdpn80',false,0);
	bar.loadPlayerYouTube('ZLnUrwvVtf0',false,0);
	baz.loadPlayerYouTube('niX8-qwlsEE',false,0);
	qux.loadPlayerYouTube('jhY0zED2P5Y',false,0);
    }
